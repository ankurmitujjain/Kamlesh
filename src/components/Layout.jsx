                    ...
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="hidden md:flex items-center space-x-6">
                            <nav className="flex space-x-6 items-center relative">
                                ...
                                {isHome ? (
                                    <a href="#about" className="text-brand-blue hover:text-brand-teal font-medium smooth-transition">About Us</a>
                                ) : (
                                ...
                                <a href="#footer" className="text-brand-blue hover:text-brand-teal font-medium smooth-transition">Contact Us</a>
                            </nav>
