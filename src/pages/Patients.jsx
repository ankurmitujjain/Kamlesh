...
const ReviewCard = ({ name, url }) => {
    return (
        <a
            href={url}
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white border border-gray-100 p-6 rounded-2xl shadow-sm hover:shadow-xl smooth-transition group flex flex-col items-center text-center h-full"
        >
            ...
            <p className="font-bold text-brand-dark text-lg group-hover:text-brand-teal smooth-transition">{name}</p>
            <div className="mt-auto pt-4 flex items-center justify-center gap-1 text-sm text-gray-500 font-medium lowercase">
                <svg className="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M12.48 10.92v3.28h7.81c-.24 1.84-.85 3.18-1.78 4.15-1.15 1.14-2.98 2.45-6.03 2.45-4.85 0-8.71-3.92-8.71-8.8s3.86-8.8 8.71-8.8c2.61 0 4.6 1.04 6.09 2.46l2.31-2.31C19.33 1.87 16.48.3 12.48.3 5.92.3.94 5.38.94 12s4.98 11.7 11.54 11.7c3.39 0 5.94-1.11 7.84-3.08 1.95-1.93 2.56-4.66 2.56-6.83 0-.58-.05-1.04-.15-1.55h-10.25z" /></svg>
...
const Patients = () => {
    ...
    const reviews = [
        { name: "Moin Shaikh", url: "https://www.google.com/maps/contrib/110834017691701032090/reviews" },
        { name: "Ayushi Rawani", url: "https://www.google.com/maps/contrib/102264543928146730654/reviews" },
        { name: "Sujeet Gharat", url: "https://www.google.com/maps/contrib/106047128396688997660/reviews" },
        { name: "Reena Bucktawar", url: "https://www.google.com/maps/contrib/108698711899501425060/reviews" },
        { name: "Chandni Agrawal", url: "https://www.google.com/maps/contrib/111214336693055521930/reviews" },
        { name: "Rekha Shanbhag", url: "https://www.google.com/maps/contrib/100966159062242160428/reviews" },
        { name: "Aniket Dhumal", url: "https://www.google.com/maps/contrib/100587927906851515339/reviews" },
        { name: "Suneet Prabhu", url: "https://www.google.com/maps/contrib/111499400948740118871/reviews" },
        { name: "Ashwini Pawar", url: "https://www.google.com/maps/contrib/110086475370865425168/reviews" },
        { name: "Swati Sapkal", url: "https://www.google.com/maps/contrib/114489235019908156253/reviews" },
        { name: "Purna Patro", url: "https://www.google.com/maps/contrib/114393223465577189427/reviews" },
        { name: "Sandeep Bhandari", url: "https://www.google.com/maps/contrib/115548701063448085353/reviews" },
        { name: "Ravi U. Yadav", url: "https://www.google.com/maps/contrib/115906408226018719749/reviews" },
    ];
    ...
    return (
        <div className="py-12 bg-brand-light">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Dynamic Patient Grid from the reference architecture */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {reviews.map((review, idx) => (
                        <ReviewCard key={idx} name={review.name} url={review.url} />
                    ))}
                </div>
